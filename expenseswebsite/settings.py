...
SECRET_KEY = 'django-insecure-3&)-q_-yb%qa4s5=$rxqylgtay@im%tf^cb^*w9#0*-y%_12lx'
...
EMAIL_HOST_USER = 'syxthanhcong.dev@gmail.com'
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = 'syxthanhcong.dev@gmail.com'
EMAIL_PORT = 587
